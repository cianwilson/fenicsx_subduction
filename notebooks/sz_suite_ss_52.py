...
utils.plot_save(plotter, "sz_suite_ss_{}_solution_{:.2f}.png".format("52", resscale))


# In[ ]:


filename = output_folder / "sz_suite_ss_{}_solution_{:.2f}.png".format("52", resscale)
...
if __name__ == "__main__" and "__file__" not in globals():
    ...
    get_ipython().system('jupyter nbconvert --NbConvertApp.export_format=script --ClearOutputPreprocessor.enabled=True sz_suite_ss_52.ipynb')
